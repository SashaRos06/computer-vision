...
for file in files:
    ...
    if found:
        ...
        cv2.putText(boxed, f'person: {conf:.2f}', (x1+5, y1+20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
...
print(f'Знайдено людей:{count_people}')
print(f'Знайдено не людей: {count_no_people}')