...
while True:
    ...
    PERSONS_CLASS_ID = 0 #Вказуємо ід класу для людей
    ...
    for r in result: #Для кожного "результату-рамки" в резльтат
        ...
        for box in boxes: #Просто стандарт
            ...
            if cls == PERSONS_CLASS_ID: #Якщо знайдений клас співпадає з нашим вказаним класом
                people_count += 1
                psevdo_id += 1
                ...
                label = f'ID {psevdo_id} cof {conf:.2f}' #2f-два знаки після коми
                #Розміщуємо текст
                ...
                cv2.putText(frame, f'People count: {people_count}', (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
